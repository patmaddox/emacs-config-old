...
(defun cheat-command (&rest rest)
  ...
  (let* ((cmd (string-join " " rest)) 
         (buffer (get-buffer-create 
                  (concat "*Cheat: " cmd "*"))))
    (shell-command (concat "/Users/padillac/.rvm/gems/ruby-1.8.7-p302/bin/cheat " cmd) buffer)))
...
(defun cheat-command-to-string (&rest rest)
  ...
  (shell-command-to-string (concat "/Users/padillac/.rvm/gems/ruby-1.8.7-p302/bin/cheat " (string-join " " rest))))
